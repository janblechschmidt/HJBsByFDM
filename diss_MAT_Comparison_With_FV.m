...
p.sigmax = 0.5;
p.sigmay = 0.5;
% savename = 'fine_sol_MAT_Pos.mat'
% The non-constant diffusion matrix example has to be uncommented in example_MinimumArrivalTime_Problem.m
savename =  'tmp.mat'
